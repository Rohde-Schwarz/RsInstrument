...
========================================
If your instrument refuses to execute desired actions, and you do not know why - after all, the SCPI commands are in the User Manual, it's worth checking whether a special option is required.
...
.. note::
    | ``instr.instrument_options`` returns a neatly sorted list of options, where the duplicates are removed, K-options are at the beginning, and the B-options at the end.
