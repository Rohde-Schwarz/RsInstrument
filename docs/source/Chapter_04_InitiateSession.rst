...
""""""""""""""""""""""""""""""""""""""""""""""""""""
Initiating new instrument session happens, when you instantiate the RsInstrument object. Below, is a simple Hello World example. Different resource names are examples for different physical interfaces.
...
""""""""""""""""""""""""""""""""""""""""""""""""""""
Just like in the function ``list_resources()``, RsInstrument allows you to choose which VISA to use:
...
.. code-block:: python
    ...
    instr = RsInstrument('TCPIP::192.168.56.101::HISLIP', True, True, "SelectVisa='rs', Simulate=True")
