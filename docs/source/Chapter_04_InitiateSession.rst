...
.. literalinclude:: Example_HelloWorld.py
   :language: python
   :linenos:
...
.. literalinclude:: Example_HelloWorldWithContextManager.py
   :language: python
   :linenos:
...
.. literalinclude:: Example_DifferentVisas.py
   :language: python
   :linenos:
...
.. literalinclude:: Example_HelloWorld_SocketIO.py
   :language: python
   :linenos:

.. warning::
    Not using VISA can cause problems when debugging, since you want to use the communication Trace Tool. The good news is, you can easily switch to use VISA and back just by changing the constructor arguments. The rest of your code stays unchanged.
...
.. literalinclude:: Example_SessionSharing.py
   :language: python
   :linenos:
