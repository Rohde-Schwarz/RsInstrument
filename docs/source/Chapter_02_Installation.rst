...
RsInstrument is hosted on `pypi.org <https://pypi.org/search/?q=rsinstrument>`_. You can install it with pip (for example ``pip.exe`` for Windows), or if you are using Pycharm (and you should be :-) directly in the Pycharm packet management GUI.
...
- Install the version 1.125.0 or newer
...
- Execute the script in your offline computer (supported is python 3.10 or newer)
- That's it ...
